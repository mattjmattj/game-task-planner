...
final class Version20211024213912 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE assignment (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, planning_id INTEGER NOT NULL, title VARCHAR(255) NOT NULL)');
        $this->addSql('CREATE INDEX IDX_E752B36A3D865311 ON assignment (planning_id)');
        ...
        $this->addSql('CREATE TABLE task (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, assignee_id INTEGER DEFAULT NULL, type_id INTEGER NOT NULL, assignment_id INTEGER NOT NULL, game INTEGER NOT NULL)');
        ...
        $this->addSql('CREATE INDEX IDX_527EDB25698C4682 ON task (assignment_id)');
